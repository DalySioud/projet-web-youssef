...
if (isset($_POST['idtopic'] ) && isset($_POST['titre'] ) && isset($_POST['description'] ) && isset($_POST['contenu'] )) 
{
    echo $_POST['idtopic'] ;
        $Topic = new topic($_POST['idtopic'] , $_POST['titre'] ,$_POST['description'],$_POST['contenu']);
                                    ...
                                    <form action="" method="POST">
                                            <table border="1" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" value="<?php echo $a['description'];?>" name="description" id="description" maxlength="40"></td>
                                                </tr>
                                                <tr>
                                                    <td>
